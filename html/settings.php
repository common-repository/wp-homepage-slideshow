...
<div class="wrap">
	...
	<form action="" method="post">
		...
		<tr>
			...
			<td>
				<input type="radio" name="settings[scale]" value="yes" <?php print (@$ops['scale'] == 'yes') ? 'checked' : ''; ?>><span><?php _e('Yes'); ?></span>
				<input type="radio" name="settings[scale]" value="no" <?php print (@$ops['scale'] == 'no') ? 'checked' : ''; ?>><span><?php _e('No'); ?></span>
			</td>
		</tr>
