...
Homepage Slide Show is a beautiful slider plugin that allows you to display slideshow on your homepage, blogposts and pages.
Also available as a widget.

== Description ==

Homepage SlideShow is a slider plugin that allows you to display slideshow on your homepage.
...
Use easy shortcodes such as [hss] or [hss cats=1,2,3] or [hss imgs=1,2,3] to see the slider. You need to create categories and upload images under them first.
